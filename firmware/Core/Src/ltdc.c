...
void MX_LTDC_Init(void) {
  ...
  hltdc.Init.HorizontalSync = HP - 1;
  hltdc.Init.VerticalSync = VP - 1;
  hltdc.Init.AccumulatedHBP = HBP - 1;
  hltdc.Init.AccumulatedVBP = VBP - 1;
  hltdc.Init.AccumulatedActiveW = HP + HBP + HDW - 1;
  hltdc.Init.AccumulatedActiveH = VP + VBP + VDW - 1;
  hltdc.Init.TotalWidth = HP + HBP + HDW + HFP - 1;
  hltdc.Init.TotalHeigh = VP + VBP + VDW + VFP - 1;
